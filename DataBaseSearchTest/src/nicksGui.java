...
public class nicksGui extends JFrame {
	...
	List<nickExperienceGUI> experiences = null;
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					experiences = FilterDb.getAllExperiences();
					for (nickExperienceGUI temp : experiences) {
						System.out.println(temp);
					}
					
				} catch (Exception exc) {
					JOptionPane.showMessageDialog(nicksGui.this, "Error: " + exc, "Error", JOptionPane.ERROR_MESSAGE); 
				}
				}
			});
		//panel.add(btnSearch);
