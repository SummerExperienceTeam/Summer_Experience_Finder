...
public class DBGui extends JFrame {
	 ...
	 * @param args
	 * @author Nick
	 * This class was disabled for version controll purposes but shown in our presentation
	 */
	...
	/**
	 * This GUI was made for customer information purposes, it simply generates a GUI which
	 * is intended to be visually appealing and gains feedback from our clients.
	 */
...
//		
	...
	//Drop down menus/ 
		...
		/**
		 * The action listener feature is added to test how will we integrate the back end demo with
		 * the gui that our customer may want.
		 * this search button simply filters out selected options.
		 */
