...
/**
 * GUI that will eventually store our filtered table, a work in progress 
 *
 */
...
public class NicksGUI extends JFrame {
	...
	NickExperience testExperience = new NickExperience(true,true,"Greenpeace","California", "Monterey", 
			"Saving the whales", "It was fun", 30, NickExperience.StudentStanding.SENIOR, NickExperience.CompensationType.UNPAID,
			NickExperience.MainActivity.VOLUNTEERING);
	/*
